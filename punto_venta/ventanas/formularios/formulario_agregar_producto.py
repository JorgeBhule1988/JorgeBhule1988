...
class FormularioAgregarProducto:
    ...
    def __init__(self, v):
        ...
        self.lname_product = Label(v, text = 'Nombre del Producto', font = ('Arial', 12, 'bold'), bg = 'Red')
        self.lcategory = Label(v, text = 'Categoria', font = ('Arial', 12, 'bold'), bg = 'Red')
        self.lprice_unit = Label(v, text = 'Precio Unitario', font = ('Arial', 12, 'bold'), bg = 'Red')
        self.lstock = Label(v, text = 'Stock', font = ('Arial', 12, 'bold'), bg = 'Red')
        self.lexitencias = Label(v, text = 'Existencia', font = ('Arial', 12, 'bold'), bg = 'Red')

        self.enombre_producto = Entry(v, width = 15)
        ...
        self.lname_product.place(x = 150, y = 40)
        self.lcategory.place(x = 150, y = 80)
        self.lprice_unit.place(x = 150, y = 120)
        self.lstock.place(x = 150, y = 160)
        self.lexitencias.place(x = 150, y = 200)
        self.enombre_producto.place(x = 350, y = 40)
        self.ecategoria.place(x = 350, y = 80)
        self.eprecio_unit.place(x = 350, y = 120)
        self.estock.place(x = 350, y = 160)
        self.eexistencias.place(x = 350, y = 200)

        self.agregar_producto = ttk.Button(v, text = 'Agregar Producto', width = 20, command = self.alta)
        self.agregar_producto.place(x = 300, y = 240)
