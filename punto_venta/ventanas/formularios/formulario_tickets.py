...
class FormularioTickets(BonotonesMenu):
    ...
    def __init__(self, window):
        ...
        frametabla.config(height = 550, width = 900)
        ...
        self.pacificos = Button(frame3, text = 'Pacifico Suave', height = 5, width = 12, command = self.botonpacificos)
        ...
        self.bcasama = Button(frame5, text = 'Casa Madero', height = 5, width = 12, command = self.botocasamadero)
        self.bcvino = Button(frame5, text = 'Copa de Vino', height = 5, width = 12, command = self.botoncopadevino)
        self.bcrose = Button(frame7, text = 'Cavall Rose', height = 5, width = 12, command = self.botoncavalrose)
        ...
        self.bcvino.place(x = 100, y = 0)
        self.cvblanco.place(x = 0, y = 0)
        self.cvrosado.place(x = 0, y = 0)
        self.bcrose.place(x = 100, y = 0)
