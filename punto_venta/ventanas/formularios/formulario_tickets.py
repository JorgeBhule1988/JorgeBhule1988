...
class FormularioTickets(BonotonesMenu):
    ...
    def generart(self):
        ...
        if self.emesa.get() == '1':
            ...
            self.bmesa6.config(state = 'normal', image = self.imagenverde6)
        elif self.emesa.get() == '7':
            self.bmesa7.config(state = 'normal', image = self.imagenverde7)
        elif self.emesa.get() == '8':
            self.bmesa8.config(state = 'normal', image = self.imagenverde8)
        elif self.emesa.get() == '9':
            self.bmesa9.config(state = 'normal', image = self.imagenverde9)
        elif self.emesa.get() == '10':
            self.bmesa10.config(state = 'normal', image = self.imagenverde10)
        elif self.emesa.get() == '11':
            self.bmesa11.config(state = 'normal', image = self.imagenverde11)
        elif self.emesa.get() == '12':
            self.bmesa12.config(state = 'normal', image = self.imagenverde12)
        elif self.emesa.get() == '13':
            self.bmesa13.config(state = 'normal', image = self.imagenverde13)
        elif self.emesa.get() == 'Cava1':
            self.bmesacv1.config(state = 'normal', image = self.imagenverdecv1)
        elif self.emesa.get() == 'Cava2':
            self.bmesacv2.config(state = 'normal', image = self.imagenverdecv2)
        elif self.emesa.get() == 'Cava3':
            self.bmesacv3.config(state = 'normal', image = self.imagenverdecv3)
        elif self.emesa.get() == 'Cava4':
            self.bmesacv4.config(state = 'normal', image = self.imagenverdecv4)
        elif self.emesa.get() == 'CasaB1':
            self.bmesacb1.config(state = 'normal', image = self.imagenverdecb1)
        elif self.emesa.get() == 'CasaB2':
            self.bmesacb2.config(state = 'normal', image = self.imagenverdecb2)
    ...
    def liberarmesa(self):
        ...
        if self.emesa.get() == '1':
            ...
            self.bmesa6.config(state = 'disable', image = self.imagenrojo6)
        elif self.emesa.get() == '7':
            self.bmesa7.config(state = 'disable', image = self.imagenrojo7)
        elif self.emesa.get() == '8':
            self.bmesa8.config(state = 'disable', image = self.imagenrojo8)
        elif self.emesa.get() == '9':
            self.bmesa9.config(state = 'disable', image = self.imagenrojo9)
        elif self.emesa.get() == '10':
            self.bmesa10.config(state = 'disable', image = self.imagenrojo10)
        elif self.emesa.get() == '11':
            self.bmesa11.config(state = 'disable', image = self.imagenrojo11)
        elif self.emesa.get() == '12':
            self.bmesa12.config(state = 'disable', image = self.imagenrojo12)
        elif self.emesa.get() == '13':
            self.bmesa13.config(state = 'disable', image = self.imagenrojo13)
        elif self.emesa.get() == 'Cava1':
            self.bmesacv1.config(state = 'disable', image = self.imagenrojocv1)
        elif self.emesa.get() == 'Cava2':
            self.bmesacv2.config(state = 'disable', image = self.imagenrojocv2)
        elif self.emesa.get() == 'Cava3':
            self.bmesacv3.config(state = 'disable', image = self.imagenrojocv3)
        elif self.emesa.get() == 'Cava4':
            self.bmesacv4.config(state = 'disable', image = self.imagenrojocv4)
        elif self.emesa.get() == 'CasaB1':
            self.bmesacb1.config(state = 'disable', image = self.imagenrojocb1)
        elif self.emesa.get() == 'CasaB2':
            self.bmesacb2.config(state = 'disable', image = self.imagenrojocb2)
    ...
    def __init__(self, window):
        ...
        self.captura = ttk.Treeview(frametabla, height= 10, columns=('#0', '#1', '#2'))
        ...
        deslizarv.place(x = 438, y = 461, relheight = 0.32)
        ...
        self.imagenrojo1 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M1_R.gif')
        self.imagenrojo2 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M3_R.gif')
        self.imagenrojo5 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M5_R.gif')
        self.imagenrojo6 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M6_R.gif')
        self.imagenrojo7 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M7_R.gif')
        self.imagenrojo8 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M8_R.gif')
        self.imagenrojo9 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M9_R.gif')
        self.imagenrojo10 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M10_R.gif')
        self.imagenrojo11 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M11_R.gif')
        self.imagenrojo12 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M12_R.gif')
        self.imagenrojo13 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M13_R.gif')
        self.imagenrojocv1 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_CAVA_1_R.gif')
        self.imagenrojocv2 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_CAVA_2_R.gif')
        self.imagenrojocv3 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_CAVA_3_R.gif')
        self.imagenrojocv4 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_CAVA_4_R.gif')
        self.imagenrojocb1 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_CB_1_R.gif')
        self.imagenrojocb2 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_CB_2_R.gif')
        self.imagenverde1 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M1.gif')
        self.imagenverde2 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M3.gif')
        self.imagenverde5 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M5.gif')
        self.imagenverde6 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M6.gif')
        self.imagenverde7 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M7.gif')
        self.imagenverde8 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M8.gif')
        self.imagenverde9 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M9.gif')
        self.imagenverde10 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M10.gif')
        self.imagenverde11 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M11.gif')
        self.imagenverde12 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M12.gif')
        self.imagenverde13 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_M13.gif')
        self.imagenverdecv1 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_CAVA_1.gif')
        self.imagenverdecv2 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_CAVA_2.gif')
        self.imagenverdecv3 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_CAVA_3.gif')
        self.imagenverdecv4 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_CAVA_4.gif')
        self.imagenverdecb1 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_CB_1.gif')
        self.imagenverdecb2 = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BOTON_CB_2.gif')
        ...
        self.bmesa5.config(state='disable', image = self.imagenrojo5)
        self.bmesa6 = Button(fmenu, height = 37, width = 80, command = self.mesa6)
        self.bmesa6.place(x = 5, y = 80)
        self.bmesa6.config(state='disable', image = self.imagenrojo6)
        self.bmesa7 = Button(fmenu, height = 37, width = 80, command = self.mesa7)
        self.bmesa7.place(x = 98, y = 80)
        self.bmesa7.config(state='disable', image = self.imagenrojo7)
        self.bmesa8 = Button(fmenu, height = 37, width = 80, command = self.mesa8)
        self.bmesa8.place(x = 190, y = 80)
        self.bmesa8.config(state='disable', image = self.imagenrojo8)
        self.bmesa9 = Button(fmenu, height = 37, width = 80, command = self.mesa9)
        self.bmesa9.place(x = 5, y = 130)
        self.bmesa9.config(state='disable', image = self.imagenrojo9)
        self.bmesa10 = Button(fmenu, height = 37, width = 80, command = self.mesa10)
        self.bmesa10.place(x = 98, y = 130)
        self.bmesa10.config(state='disable', image = self.imagenrojo10)
        self.bmesa11 = Button(fmenu, height = 37, width = 80, command = self.mesa11)
        self.bmesa11.place(x = 190, y = 130)
        self.bmesa11.config(state='disable', image = self.imagenrojo11)
        self.bmesa12 = Button(fmenu, height = 37, width = 80, command = self.mesa12)
        self.bmesa12.place(x = 5, y = 180)
        self.bmesa12.config(state='disable', image = self.imagenrojo12)
        self.bmesa13 = Button(fmenu, height = 37, width = 80, command = self.mesa13)
        self.bmesa13.place(x = 98, y = 180)
        self.bmesa13.config(state='disable', image = self.imagenrojo13)
        self.bmesacv1 = Button(fmenu, height = 37, width = 80, command = self.mesac1)
        self.bmesacv1.place(x = 190, y = 180)
        self.bmesacv1.config(state='disable', image = self.imagenrojocv1)
        self.bmesacv2 = Button(fmenu, height = 37, width = 80, command = self.mesac2)
        self.bmesacv2.place(x = 5, y = 230)
        self.bmesacv2.config(state='disable', image = self.imagenrojocv2)
        self.bmesacv3 = Button(fmenu, height = 37, width = 80, command = self.mesac3)
        self.bmesacv3.place(x = 98, y = 230)
        self.bmesacv3.config(state='disable', image = self.imagenrojocv3)
        self.bmesacv4 = Button(fmenu, height = 37, width = 80, command = self.mesac4)
        self.bmesacv4.place(x = 190, y = 230)
        self.bmesacv4.config(state='disable', image = self.imagenrojocv4)
        self.bmesacb1 = Button(fmenu, height = 37, width = 80, command = self.mesacasab1)
        self.bmesacb1.place(x = 5, y = 280)
        self.bmesacb1.config(state='disable', image = self.imagenrojocb1)
        self.bmesacb2 = Button(fmenu, height = 37, width = 80, command = self.mesacasab2)
        self.bmesacb2.place(x = 98, y = 280)
        self.bmesacb2.config(state='disable', image = self.imagenrojocb2)
        ...
        self.imagencaja_registradora = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\CAJA_REGISTRADORA.gif')
        self.imagenSuma = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\TOTAL_CUENTA.gif')
        self.bguardar = Button(fcobro, image = self.imagenSuma, height = 70, width = 70, command = self.sumartotales)
        self.bguardar.place(x = 200, y = 85)
        self.bguardar.config(state = 'disable')
        self.imagenLimpiar = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BORRAR_FILA.png')
        self.blimpiar = Button(frametabla, image = self.imagenLimpiar, height= 85, width = 85, command = self.Limpiarticket)
        self.blimpiar.place(x = 100, y = 365)
        self.cancelar_producto = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\CANCELAR_PRODUCTO.png')
        self.cproducto = Button(frametabla, image = self.cancelar_producto, height = 85, width = 65, command = self.questdelete)
        self.cproducto.place(x = 290, y = 365)
        self.imagenEliminar = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\BORRAR_PRODUCTO.gif')
        self.celiminar = Button(frametabla, image = self.imagenEliminar, height= 85, width = 85, command = self.eliminarfila)
        self.celiminar.config(state = 'disable')
        self.celiminar.place(x = 365, y = 365)
        self.imagenAgregar = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\AGREGAR_PRODUCTO.gif')
        self.cerrart = Button(frametabla, image = self.imagenAgregar, height= 85, width = 85, command = self.generart)
        self.cerrart.place(x = 195, y = 365)
        ...
        self.alta_producto = Button(window, text = 'Alta Producto', width = 37, bg = '#D67B03', font = ('Arial', 9, 'bold'))
        self.alta_producto.place(x = 460, y = 363)
        self.binventario = Button(window, text = 'Inventario Producto', width = 37, bg = '#D67B03', font = ('Arial', 9, 'bold'))
        self.binventario.place(x = 730, y = 363)
        self.aproducto = Button(self.frame15, text = 'Agregar', width = 10, bg = '#D67B03', font = ('Arial', 9, 'bold'), command = self.agregar_producto)
        self.aproducto.place(x = 380, y = 265)
        self.imagenimpresora = PhotoImage( file = 'C:\\Users\\bhule\\OneDrive\\Escritorio\\Diplomado Python\PuntodeVenta\\ventanas\\imagenes\\IMPRIMIR_TICKET.gif')
