...
class FormularioTickets(BonotonesMenu):
    ...
    def __init__(self, window):
        ...
        self.colezione = Button(frame5, text = 'Colezione', height = 5, width = 12, command = self.colezionemolte)
